/*
 * 【役目を終えました。もう実行しないでください】 2026-08-11
 *
 * 8/9 の記録を Supabase へ移すために作ったもの。
 * ところがそのあと 8/10 の記録が受け渡しで先に入り、前提が変わった。
 * このまま流すと、8/10 に入ったぶんと重なる。
 *
 * 実際の反映は、いまの状態に合わせて1件ずつ確認しながら行った(2026-08-11 完了)。
 * 残してあるのは、当時どう判断したかを後から辿るため。
 * 同じことをする必要が出たら、まず現状を読んでから作り直すこと。
 */
/**
